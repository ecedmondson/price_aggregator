...
class Decluttr(BaseMultiplesClient):
    ...
    def parse_web_element(self, element):
        ...
        return ScrapedProduct(self.msrp, self.product_name, self.source, get_price(element), self.product_type, photo=get_photo(element), instock="In Stock", new=self.use_status, product_link=self.product_url)
